...
class SectionSportModern extends StatefulWidget {
  final List<ArticlesModel> articles;
  
  const SectionSportModern({super.key, required this.articles});

  @override
  State<SectionSportModern> createState() => _SectionSportModernState();
}

class _SectionSportModernState extends State<SectionSportModern> {
  int _hoveredIndex = -1;
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(width: 4),
                                      Text(
                                        widget.articles[0].tags?.titre?.toUpperCase() ?? 'SPORT',
                                        style: fontFammilyDii(
                                          context,
                                          10,
                                          blanc,
