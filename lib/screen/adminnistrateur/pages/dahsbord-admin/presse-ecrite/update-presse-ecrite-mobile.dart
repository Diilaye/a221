...
class UpdatePresseEcriteScreenMobile extends StatefulWidget {
  const UpdatePresseEcriteScreenMobile({super.key});

  @override
  State<UpdatePresseEcriteScreenMobile> createState() =>
      _UpdatePresseEcriteScreenMobileState();
}

class _UpdatePresseEcriteScreenMobileState
    extends State<UpdatePresseEcriteScreenMobile> {
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text(
                      'Modifier Presse écrite'.toUpperCase(),
                  ...
                  children: [
                    ...
                    Expanded(
                        child: GestureDetector(
                            // onTap: () => jourPapierBloc.getImageJournalUpdate(),
                            child: jourPapierBloc.fileModel == null
                                ...
                                : Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                            fit: BoxFit.cover,
                                            image: AssetImage(BASE_URL_ASSET +
                                                jourPapierBloc
                                                    .fileModel!.url!)),
                                        boxShadow: [
                                          BoxShadow(
                ...
                Row(
                  ...
                  children: [
                    Card(
                      ...
                      child: GestureDetector(
                        onTap: () => jourPapierBloc.updateJournalPapier(),
                        child: SizedBox(
                          height: 40,
                          child: Row(
                            children: [
                    ...
                    GestureDetector(
                      onTap: () => jourPapierBloc.setShowUpdate(0),
                      child: Card(
                        elevation: 2,
                        color: blanc,
                        shape: RoundedRectangleBorder(
