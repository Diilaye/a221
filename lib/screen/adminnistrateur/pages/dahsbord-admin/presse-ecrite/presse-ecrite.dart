...
class PresseEcriteScreen extends StatelessWidget {
  const PresseEcriteScreen({super.key});
        ...
        if (menuAdminBloc.addPresseEcrite == 1)
          Positioned(
              ...
              child: SizedBox(
                width: size.width * .8,
                height: size.height,
                child: const AddPresseEcriteScreen(),
              )),
        if (jourPapierBloc.showUpdate == 1)
          Positioned(
              ...
              child: SizedBox(
                width: size.width * .8,
                height: size.height,
                child: const UpdatePresseEcriteScreen(),
              )),
      ],
    );
  }
