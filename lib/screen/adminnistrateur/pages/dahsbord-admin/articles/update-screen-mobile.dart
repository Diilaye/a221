// FICHIER NETTOYÉ - VERSION RESPONSIVE MODERNE
...
class UpdateArticleScreenMobile extends StatefulWidget {
  const UpdateArticleScreenMobile({super.key});

  @override
  State<UpdateArticleScreenMobile> createState() => _UpdateArticleScreenMobileState();
}

class _UpdateArticleScreenMobileState extends State<UpdateArticleScreenMobile> with AutomaticKeepAliveClientMixin {
  ...
  Widget build(BuildContext context) {
    ...
    // Détection du mode responsive
    bool isMobile = size.width < 600;
    bool isTablet = size.width >= 600 && size.width < 1024;
    
    double padding = isMobile ? 12 : (isTablet ? 20 : 24);
    double fontSize = isMobile ? 12 : 14;
    double titleSize = isMobile ? 18 : 24;
    int gridColumns = isMobile ? 2 : (isTablet ? 3 : 5);
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              if (!isMobile)
                                Text(
                                  'Modifiez et mettez à jour votre article',
                                  style: TextStyle(
                      ...
                      child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: ElevatedButton.icon(
                                      onPressed: () => addArticleBloc.getImageArticleUpdate(),
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              // Première ligne: Annuler et Archiver
                              Row(
                                children: [
                                  Expanded(
                                    child: ElevatedButton.icon(
                                      onPressed: () => addArticleBloc.setShowUpdate(0),
                                      icon: Icon(Icons.close, size: isMobile ? 18 : 22),
                                      label: Text(
                                        'Annuler',
                                        style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                  ...
                                  Expanded(
                                    child: ElevatedButton.icon(
                                      ...
                                      icon: Icon(Icons.archive, size: isMobile ? 18 : 22),
                                      label: Text(
                                        'Archiver',
                                        style: TextStyle(
                                          fontWeight: FontWeight.bold,
                              ...
                              // Deuxième ligne: Brouillon
                              ElevatedButton.icon(
                                onPressed: () => addArticleBloc.updateArticleStatut('brouillon'),
                                icon: Icon(Icons.save, size: isMobile ? 18 : 22),
                                label: Text(
                              ...
                              ElevatedButton.icon(
                                ...
                                icon: addArticleBloc.chargement
                                    ...
                                    : Icon(CupertinoIcons.check_mark_circled, size: isMobile ? 18 : 22),
                                label: Text(
                                  addArticleBloc.chargement ? 'Mise à jour...' : 'Publier l\'article',
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: isMobile ? 13 : 16,
                                  ),
