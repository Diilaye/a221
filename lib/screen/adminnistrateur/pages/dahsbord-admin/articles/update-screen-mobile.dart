...
class UpdateArticleScreenMobile extends StatefulWidget {
  ...
  @override
  State<UpdateArticleScreenMobile> createState() =>
      _UpdateArticleScreenMobileState();
}

class _UpdateArticleScreenMobileState extends State<UpdateArticleScreenMobile> {
                ...
                Row(
                  children: [
                    ...
                    Text(
                      ...
                      style: fontFammilyDii(context, 13, rouge, FontWeight.bold,
                          FontStyle.normal),
                    )
                  ],
                ),
                ...
                Row(
                  children: [
                    ...
                    Text(
                      ...
                      style: fontFammilyDii(context, 10, rouge, FontWeight.bold,
                          FontStyle.normal),
                    )
                  ],
                ),
