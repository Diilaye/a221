...
class UpdatePostDigiteauxScreenMobile extends StatefulWidget {
  const UpdatePostDigiteauxScreenMobile({super.key});

  @override
  State<UpdatePostDigiteauxScreenMobile> createState() =>
      _UpdatePostDigiteauxScreenMobileState();
}

class _UpdatePostDigiteauxScreenMobileState
    extends State<UpdatePostDigiteauxScreenMobile> {
