...
import 'package:actu/screen/adminnistrateur/pages/dahsbord-admin/params/mots-cles/add-key-world-screen.dart';
import 'package:actu/screen/adminnistrateur/pages/dahsbord-admin/params/mots-cles/update-key-world-screen.dart';
...
class KeyWorlScreen extends StatelessWidget {
  const KeyWorlScreen({super.key});
          ...
          children: [
            ...
            Row(
              children: [
                        ...
                        Expanded(
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              hintText: "RECHERCHER UN mots clés".toUpperCase(),
                ...
                paddingHorizontalGlobal(),
                GestureDetector(
                  onTap: () => menuAdminBloc.setKeyWord(1),
                  child: CircleAvatar(
                                        ...
                                        children: [
                                          ...
                                          Expanded(
                                            ...
                                            children: [
                                              ...
                                              IconButton(
                                                  onPressed: () {
                                                    motsClesBloc.setMotCles(e);
                                                    motsClesBloc
                                                        .setShowUpdate(1);
                                                  },
                                                  tooltip:
                                                      "Modifier sous mots cmes",
                                                  icon:
                                              ...
                                              IconButton(
                                                  onPressed: () async =>
                                                      dialogRequest(
                                                              title:
                                                                  'Vous êtes sur de vouloir suprimer ce mot cles ',
                                                              context: context)
                                                          .then((value) async {
                                                        if (value) {
                                                          motsClesBloc
            ...
            Row(
              children: [
                paddingHorizontalGlobal(8),
                Text(
                  "Affichage de 1 à 10 sur ${motsClesBloc.motCles.length} mots cles",
        ...
        if (menuAdminBloc.keyWord == 1)
          Positioned(
              ...
              child: SizedBox(
                width: size.width * .64,
                height: size.height,
                child: const AddKeyWorldScreen(),
              )),
        if (motsClesBloc.showUpdate == 1)
          Positioned(
              top: 0,
              right: 0,
              child: SizedBox(
                width: size.width * .64,
                height: size.height,
                child: const UpdateKeyWorldScreen(),
              )),
      ],
    );
  }
