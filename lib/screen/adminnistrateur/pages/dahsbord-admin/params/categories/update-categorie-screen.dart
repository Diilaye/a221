...
class UpdateCategorieScreen extends StatefulWidget {
  const UpdateCategorieScreen({super.key});
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Text(
                'Modifier catégorie '.toUpperCase(),
              ...
              Expanded(
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: "Modifier categorie".toUpperCase(),
            ...
            children: [
              Card(
                ...
                child: GestureDetector(
                  onTap: () => categorieBloc.updateCategorie(context),
                  child: SizedBox(
                    height: 40,
                    child: Row(
                      children: [
              ...
              GestureDetector(
                onTap: () => categorieBloc.setShowUpdate(0),
                child: Card(
                  elevation: 2,
                  color: blanc,
                  shape: RoundedRectangleBorder(
