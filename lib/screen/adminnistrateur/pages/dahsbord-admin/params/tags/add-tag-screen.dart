...
class _AddTagScreenState extends State<AddTagScreen> with SingleTickerProviderStateMixin {
            ...
            children: [
              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                    _buildFormCard(context, tagsBloc),
                    const SizedBox(height: 32),
                    _buildActionButtons(context, tagsBloc, menuAdminBloc),
                  ],
                ),
              ),
            ],
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Créez un nouveau tag pour organiser vos articles',
                  style: TextStyle(
  ...
  Widget _buildFormCard(BuildContext context, TagsBloc tagsBloc) {
    return Container(
      padding: const EdgeInsets.all(32),
      decoration: BoxDecoration(
        color: Colors.white,
      ...
      child: Column(
        ...
        children: [
          ...
          _buildTextField(
            context,
            controller: tagsBloc.titre,
            label: 'Titre du tag',
            hint: 'Saisissez le titre du tag...',
  ...
  Widget _buildActionButtons(BuildContext context, TagsBloc tagsBloc, MenuAdminBloc menuAdminBloc) {
    return Row(
      children: [
        Expanded(
          child: MouseRegion(
            cursor: SystemMouseCursors.click,
            child: GestureDetector(
              onTap: tagsBloc.chargement ? null : () => menuAdminBloc.setTag(0),
              child: Container(
        ...
        Expanded(
          flex: 2,
          child: MouseRegion(
            cursor: tagsBloc.chargement ? SystemMouseCursors.wait : SystemMouseCursors.click,
            child: GestureDetector(
              onTap: tagsBloc.chargement ? null : () => tagsBloc.addTags(context),
              child: Container(
                padding: const EdgeInsets.symmetric(vertical: 16),
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 8),
                    Text(
                      tagsBloc.chargement ? 'ENREGISTREMENT...' : 'AJOUTER LE TAG',
                      style: TextStyle(
                        color: blanc,
                        fontSize: 14,
                        fontWeight: FontWeight.w900,
